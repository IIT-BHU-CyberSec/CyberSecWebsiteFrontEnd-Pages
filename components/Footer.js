...
export default function Footer() {
    ...
    const copyMail = () => {
        navigator.clipboard.writeText('iitbhucybersec@gmail.com')
        setShowTooltip(() => true)
        setTimeout(() => {
    ...
    return (
        <div id="footer" className="py-2">
            <div className="container text-center">
                <a
                    className="light-color-links mx-2"
                ...
                <a
                    className="light-color-links mx-2"
                    href="https://www.linkedin.com/company/iit-bhu-cybersec/"
                >
                ...
                <a className="light-color-links mx-2" onClick={copyMail}>
                    <AiOutlineMail size={30} />
                </a>

                {showTooltip && (
                    <span
                        className="position-absolute bg-success rounded light-color p-2"
                ...
                <div className="light-color text-center">
                    &copy; Copyright IIT(BHU)CyberSec
                </div>
            </div>
